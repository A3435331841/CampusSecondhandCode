...
public class ChatWebSocketHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        ack.setToUserId(msg.getToUserId());
        ack.setProductId(msg.getProductId());
        ack.setTimestamp(msg.getTimestamp());
        ack.setContent(targetSession != null && targetSession.isOpen() ? "delivered" : "pending");
        if (session.isOpen()) {
